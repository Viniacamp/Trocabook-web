...
@Controller
public class CadastroControllerFirebase {
    ...
    public CadastroControllerFirebase(
    ...
    public String cadastrar(
         ...
         */
        UsuarioFirebaseInput input =
                new UsuarioFirebaseInput(
